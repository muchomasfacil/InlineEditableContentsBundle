 ...
 */
class ContentRepository extends EntityRepository ContainerAware
{
    ...
    public function findOrCreateIfNotExist($handler, $entity_name = 'PlainText', $collection_length = 1, $default = array())
    {
        ...
        if (!$content){
            ...
            //set form_template
            if (isset($default['form_template'])) {
                $content->setFormTemplate($default['form_template']);
            }
            else {
                $content->setFormTemplate('MuchoMasFacilInlineEditableContentsBundle:Content:Includes/form_template.html.twig');
            }
